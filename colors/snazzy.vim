...
let  soilpink_bright   =  '#c59378'
let  soilpink_dark     =  '#33261f'
let  soilpink   =  '#46342b'
...
:exe  'highlight  WildMenu        guifg=NONE         guibg='.ui_4.'    guisp='.ui_4.'    gui=NONE       ctermfg=255  ctermbg=248   cterm=NONE'
...
:exe  'highlight  StatusLineNC    guifg='.ui_2.'     guibg='.ui_8.'   guisp='.ui_9.'    gui=bold       ctermfg=255   ctermbg=239   cterm=bold'
...
:exe  'highlight  StatusLine      guifg='.ui_2.'     guibg='.terminal_color_4.'    guisp='.ui_9.'    gui=bold       ctermfg=255   ctermbg=239   cterm=bold'
:exe  'highlight  Label           guifg='.yellow.'   guibg=NONE        guisp=NONE        gui=bold       ctermfg=229   ctermbg=NONE  cterm=bold'
:exe  'highlight  PMenuSel        guifg='.soilpink_dark.'    guibg='.soilpink_bright.'    guisp='.ui_9.'    gui=NONE       ctermfg=84    ctermbg=239   cterm=bold'
...
:exe  'highlight  TabLineSel      guifg='.ui_3.'     guibg='.ui_5.'   guisp='.ui_11.'   gui=bold       ctermfg=255   ctermbg=237   cterm=bold'
...
:exe  'highlight  PMenu           guifg='.soilpink.'     guibg='.soilpink_bright.'    guisp='.ui_9.'    gui=NONE       ctermfg=255   ctermbg=239   cterm=NONE'
...
:exe  'highlight  TabLine         guifg='.ui_2.'     guibg='.ui_11.'    guisp='.ui_9.'    gui=bold       ctermfg=255   ctermbg=239   cterm=bold'
